function [bneed, pulsewb, irf, irfsim, irf_pdf, wig, tmini, tmaxi, ext,varargout] =...
    make_irf_wig_ext_minres(pth_irf, irfname, pth_wigs, wigsname, pth_ext, ...
    extname, data_shift_name, pth_data_for_shift,sfrac, shiftmin, shiftmax,...
    w2step, w2min, w2max, backstep, backmin, backmax)
