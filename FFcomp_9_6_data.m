...
sept6_1e6 = [17295:17340,17342:17392,17393:17416,17418:17442];
...
if isempty(c1index)
    ...
    numtp10 = length([17295:17340,17342:17392]);
    numtp60 = length([17393:17416,17418:17442]);
...
for j = 1:ind
    ...
    if isequal(ivec, sept6_2e5)
        ...
        if j<numtp10
            ...
            plot(x_plot(1:numtp10),ave_FRET(1:numtp10),'.','MarkerSize',10);
            plot(x_plot(numtp10+1:j),ave_FRET(numtp10+1:j),'g.','MarkerSize',10);
        end
    end
    ylabel('FRET fraction');
