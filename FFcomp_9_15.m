...
sept14 = [18192:18241,18242:18291,18292:18341];
sept15 = [18342:18391,18492:18541,18392:18441,18542:18591,18442:18491];


ivec = sept13; %[jul31_donor_ran,jul31_uf1_ran,jul31_uf2_ran];
acq_time = 20;
%%%
show_fit=1;
show_images=1;
...
if isempty(c1index)
    ...
    FFearly_mix = (ave_FRET(1:50) + ave_FRET(51:100))/2;
    FFlate_mix = (ave_FRET(101:150) + ave_FRET(151:200))/2;
    FFsep_mix = ave_FRET(201:250);
    
    numsam1 = 50;
    numsam2 = 50;
    numsam3 = 50;
    ave_FRET = [FFearly_mix,FFlate_mix,FFsep_mix];
    ind = length(ave_FRET);
    
    x_plot = (start_time:save_time:start_time+save_time*(50-1))./60;
    x_plot = [x_plot,x_plot,x_plot];
...
sumxmat = sum(xmat,2);
sumearly_mix = (sumxmat(1:50) + sumxmat(51:100))/2;
sumlate_mix = (sumxmat(101:150) + sumxmat(151:200))/2;
sumsep_mix = sumxmat(201:250);
sumxmat = [sumearly_mix',sumlate_mix',sumsep_mix'];
